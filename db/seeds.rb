...
Service.destroy_all
Service.create(name: "Cleaning", price: 100, tagligne: "test", photo: "cleaning")
...
Service.create(name: "Body Sushis", price: 100, tagligne: "test", photo: "sushi")
Service.create(name: "Dance", price: 200, tagligne: "test", photo: "dance")
Service.create(name: "Coach Sportif", price: 250, tagligne: "test", photo: "coach")
Service.create(name: "Body Massage", price: 150, tagligne: "test", photo: "massage")
